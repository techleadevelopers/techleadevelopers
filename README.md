...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,js,react,vite,ts,next,typescript,python,goland,pytorch,tersorflow,expressjs,nodejs,mongodb,firebase,md,git,github,vscode,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
