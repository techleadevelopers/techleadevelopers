...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,js,react,vite,ts,next,python,expressjs,nodejs,mongodb,firebase,md,git,github,vscode,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
